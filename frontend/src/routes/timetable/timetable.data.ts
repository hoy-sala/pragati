...
const RAW: Record<string, Record<string, string[]>> = {
  'Class 6': {
    Mon: ['MAT', 'ENG', 'DRW', 'SCI', 'KAN', 'CS', 'SOC', 'HIN'],
    Tue: ['SOC', 'MAT', 'LIB', 'HIN', 'ENG', 'DRW', 'SCI', 'KAN'],
  ...
  'Class 7': {
    ...
    Tue: ['SCI', 'KAN', 'MAT', 'LIB', 'HIN', 'ENG', 'SOC', 'CS'],
  ...
  'Class 8': {
    ...
    Tue: ['HIN', 'ENG', 'PE', 'SCI', 'KAN', 'SOC', 'MAT', 'MUS'],
  ...
  'Class 9': {
    ...
    Tue: ['KAN', 'SCI', 'ENG', 'MUS', 'SOC', 'HIN', 'DRW', 'MAT'],
  ...
  'Class 10': {
    ...
    Tue: ['MUS', 'HIN', 'SOC', 'MAT', 'SCI', 'PE', 'KAN', 'ENG'],
