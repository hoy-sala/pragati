...
const RAW: Record<string, Record<string, string[]>> = {
  'Class 6': {
    Mon: ['KAN', 'MAT', 'SOC', 'MUS', 'SCI', 'ENG', 'CS', 'HIN'],
    Tue: ['SOC', 'MAT', 'ENG', 'SCI', 'HIN', 'PE', 'KAN', 'DRW'],
    Wed: ['SCI', 'DRW', 'KAN', 'MAT', 'LIB', 'HIN', 'ENG', 'SOC'],
    Thu: ['MAT', 'KAN', 'CS', 'SCI', 'LIB', 'SOC', 'ENG', 'HIN'],
    Fri: ['ENG', 'MAT', 'SOC', 'KAN', 'PE', 'MUS', 'SCI', 'CUL'],
    Sat: ['CS', 'HIN', 'MUS', 'ENG'],
  },
  'Class 7': {
    Mon: ['ENG', 'KAN', 'CS', 'HIN', 'SOC', 'MUS', 'MAT', 'SCI'],
    Tue: ['KAN', 'SOC', 'PE', 'MAT', 'SCI', 'CS', 'ENG', 'HIN'],
    Wed: ['SOC', 'LIB', 'HIN', 'KAN', 'DRW', 'SCI', 'MAT', 'ENG'],
    Thu: ['SCI', 'MUS', 'ENG', 'KAN', 'SOC', 'HIN', 'MAT', 'LIB'],
    Fri: ['MAT', 'DRW', 'ENG', 'SOC', 'SCI', 'PE', 'KAN', 'CUL'],
    Sat: ['KAN', 'MAT', 'SCI', 'SOC'],
  },
  'Class 8': {
    Mon: ['HIN', 'DRW', 'SCI', 'MAT', 'ENG', 'KAN', 'SOC', 'CS'],
    Tue: ['HIN', 'KAN', 'DRW', 'ENG', 'MAT', 'SCI', 'MUS', 'SOC'],
    Wed: ['HIN', 'SOC', 'CS', 'ENG', 'MAT', 'PE', 'SCI', 'KAN'],
    Thu: ['HIN', 'SOC', 'LIB', 'MAT', 'ENG', 'KAN', 'SCI', 'MUS'],
    Fri: ['SCI', 'LIB', 'PE', 'ENG', 'KAN', 'SOC', 'MAT', 'CUL'],
    Sat: ['MAT', 'SCI', 'SOC', 'KAN'],
  },
  'Class 9': {
    Mon: ['MAT', 'SOC', 'LIB', 'KAN', 'PE', 'SCI', 'HIN', 'ENG'],
    Tue: ['ENG', 'SCI', 'MUS', 'HIN', 'KAN', 'MAT', 'SOC', 'PE'],
    Wed: ['KAN', 'ENG', 'SCI', 'CS', 'HIN', 'SOC', 'MUS', 'MAT'],
    Thu: ['SOC', 'LIB', 'DRW', 'HIN', 'MAT', 'SCI', 'KAN', 'ENG'],
    Fri: ['SOC', 'KAN', 'CS', 'SCI', 'MAT', 'DRW', 'ENG', 'CUL'],
    Sat: ['SCI', 'SOC', 'KAN', 'MAT'],
  },
  'Class 10': {
    Mon: ['SCI', 'HIN', 'ENG', 'CS', 'MAT', 'SOC', 'KAN', 'DRW'],
    Tue: ['MAT', 'HIN', 'LIB', 'SOC', 'PE', 'KAN', 'SCI', 'ENG'],
    Wed: ['ENG', 'MAT', 'MUS', 'SCI', 'SOC', 'CS', 'KAN', 'HIN'],
    Thu: ['KAN', 'ENG', 'SCI', 'SOC', 'HIN', 'MAT', 'LIB', 'PE'],
    Fri: ['KAN', 'SCI', 'DRW', 'MAT', 'MUS', 'ENG', 'SOC', 'CUL'],
    Sat: ['SOC', 'KAN', 'MAT', 'SCI'],
  },
};
