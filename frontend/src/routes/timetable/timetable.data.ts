...
const RAW: Record<string, Record<string, string[]>> = {
  'Class 6': {
    ...
    Wed: ['KAN', 'HIN', 'MAT', 'SOC', 'ENG', 'CS', 'SCI', 'MUS'],
  ...
  'Class 10': {
    ...
    Thu: ['HIN', 'SCI', 'KAN', 'MAT', 'SOC', 'CS', 'DRW', 'ENG'],
