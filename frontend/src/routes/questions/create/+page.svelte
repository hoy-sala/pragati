...
<div class="max-w-2xl mx-auto space-y-6">
  <div class="flex items-center gap-4">
    <a href="/questions" class="text-slate-400 hover:text-slate-600"
      >&larr; Back</a
    >
  ...
  >
    <div class="grid grid-cols-2 gap-4">
      <div>
        <label
          for="subject"
          class="block text-sm font-medium text-slate-700 mb-1">Subject *</label
        >
        <Select
          id="subject"
      ...
      <div>
        <label for="marks" class="block text-sm font-medium text-slate-700 mb-1"
          >Marks</label
        >
        <input
          id="marks"
    ...
    <div>
      <label
        for="question"
        class="block text-sm font-medium text-slate-700 mb-1">Question *</label
      >
      <textarea
        id="question"
    ...
    <div>
      <label
        for="chapters"
        class="block text-sm font-medium text-slate-700 mb-1">Chapters</label
      >
      <input
        id="chapters"
        type="text"
        ...
        {#each options as opt, i}
          <div class="flex items-center gap-3">
            <button
              ...
              class="w-5 h-5 rounded-full border-2 flex items-center justify-center text-xs {opt.correct
    ...
    {#if error}
      <div class="text-sm text-danger-600 bg-danger-50 rounded-lg p-3">
        {error}
      </div>
    {/if}
